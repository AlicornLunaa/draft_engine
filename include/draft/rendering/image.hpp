...
namespace Draft {
    ...
    public:
        // Constructors
        Image(unsigned int width, unsigned int height, Vector4f color = {1, 1, 1, 1}, ColorSpace colorSpace = ColorSpace::RGBA);
        ...
        Vector4f get_pixel(Vector2u position);

        inline const std::byte* c_arr(){ return data; }
