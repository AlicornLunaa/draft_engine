...
namespace Draft {
    ...
    /**
     * @brief OpenGL vertex array object wrapping one or more VBOs (each STATIC or DYNAMIC, each
     * with its own vertex attribute layout). Do not construct before an OpenGL context was established.
     */
    class VertexArray {
    private:
        // Types
