...
namespace Draft {
    /**
     * @brief Base camera: position/orientation + view/projection matrices. Pure math, the only
     * thing here that touches a live GL context is `apply()`, which just delegates to
     * `Shader::set_uniform`.
     */
    class Camera {
    protected:
