...
#include "draft/physics/mass_data.hpp"
...
namespace Draft {
    ...
    private:
        ...
        std::vector<Collider*> attachedColliders; // Non-owning, invalidated on destruction
    ...
    public:
        ...
        // Friends :)
        friend class World;
        friend class Collider; // Registers/unregisters itself in attachedColliders on attach/detach
