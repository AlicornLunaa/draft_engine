...
namespace Draft {
    ...
    private:
        ...
        // when it is torn down while this Collider is still attached to it, so this Collider
        // doesn't dangle a pointer to a dead body afterward.
        void invalidate();
    ...
    public:
        ...
        // Friends :)
        friend class RigidBody; // Calls invalidate() when this body is destroyed while attached
