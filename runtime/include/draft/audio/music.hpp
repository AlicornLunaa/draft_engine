...
namespace Draft {
    /**
     * @brief A single, streamed audio track (loaded and decoded incrementally as it plays,
     * unlike Sound/SoundBuffer which decode everything up front)
     */
    class Music {
    private:
        // Types
    ...
    public:
        ...
        /**
         * @brief FileHandle has no partial/streaming and streams the decode from there instead of from disk directly.
         */
