...
namespace Draft {
    ...
    Vector2f Joint::get_anchor_a() const { return b2_to_vector<float>(ptr->joint->GetAnchorA()); }
    Vector2f Joint::get_anchor_b() const { return b2_to_vector<float>(ptr->joint->GetAnchorB()); }
