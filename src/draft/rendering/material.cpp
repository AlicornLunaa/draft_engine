...
namespace Draft {
    // Constructors
    Material::Material(const AssetManager& assets, const std::string& name) : name(name), debugWhite(assets.get_debug_white()), debugBlack(assets.get_debug_black()), emptyNormalMap(assets.get_empty_normal_map()) {}
