...
namespace Clydesdale::Phys {
    ...
    public:
        ...
        inline const b2Vec2& getPosition() const { return body->GetPosition(); }
        ...
        inline const b2Vec2& getWorldCenter() const { return body->GetWorldCenter(); }

        /// Get the local position of the center of mass.
        inline const b2Vec2& getLocalCenter() const { return body->GetLocalCenter(); }

        /// Set the linear velocity of the center of mass.
        /// @param v the new linear velocity of the center of mass.
        inline void setLinearVelocity(const b2Vec2& v) { body->SetLinearVelocity(v); }

        /// Get the linear velocity of the center of mass.
        /// @return the linear velocity of the center of mass.
        inline const b2Vec2& getLinearVelocity() const { return body->GetLinearVelocity(); }
        ...
        inline b2Vec2 getWorldPoint(const b2Vec2& localPoint) const { return body->GetWorldPoint(localPoint); }

        /// Get the world coordinates of a vector given the local coordinates.
        /// @param localVector a vector fixed in the body.
        /// @return the same vector expressed in world coordinates.
        inline b2Vec2 getWorldVector(const b2Vec2& localVector) const { return body->GetWorldVector(localVector); }

        /// Gets a local point relative to the body's origin given a world point.
        /// @param worldPoint a point in world coordinates.
        /// @return the corresponding local point relative to the body's origin.
        inline b2Vec2 getLocalPoint(const b2Vec2& worldPoint) const { return body->GetLocalPoint(worldPoint); }

        /// Gets a local vector given a world vector.
        /// @param worldVector a vector in world coordinates.
        /// @return the corresponding local vector.
        inline b2Vec2 getLocalVector(const b2Vec2& worldVector) const { return body->GetLocalVector(worldVector); }

        /// Get the world linear velocity of a world point attached to this body.
        /// @param worldPoint a point in world coordinates.
        /// @return the world velocity of a point.
        inline b2Vec2 getLinearVelocityFromWorldPoint(const b2Vec2& worldPoint) const { return body->GetLinearVelocityFromWorldPoint(worldPoint); }

        /// Get the world velocity of a local point.
        /// @param localPoint a point in local coordinates.
        /// @return the world velocity of a point.
        inline b2Vec2 getLinearVelocityFromLocalPoint(const b2Vec2& localPoint) const { return body->GetLinearVelocityFromLocalPoint(localPoint); }
